...
public class Caller_register extends Caller {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = new Intent(this, Caller.class);
    ...
    public void funcVoiceOut(String OutMsg){                    // 음성을 말해주는 기능
        ...
        if(!tts.isSpeaking()) {
            if(OutMsg.equals("다시 입력") || OutMsg.equals("다시입력")) {
                tts.speak("처음부터 다시 입력해주세요.", TextToSpeech.QUEUE_FLUSH, null);
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(tel.length() == 0 || name.length() == 0) {
                        ...
                        funcVoiceOut("다시 입력하고 싶다면 '다시 입력'이라고 말씀해주세요. 다 입력하셨다면 '입력 완료'라고 말씀해주세요.");
                        try {
                            sleep(11000);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
